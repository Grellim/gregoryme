...
export default function ProfileModal({ isOpen, onClose, initialData, onSave }: ProfileModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[60%] max-w-[60vw] md:max-w-4xl lg:max-w-5xl xl:max-w-6xl max-h-[95vh] p-0 overflow-y-auto pb-[25px] sm:rounded-2xl focus:outline-none scrollbar scrollbar-w-4 scrollbar-thumb-gray-400 scrollbar-track-transparent">
        ...
        <div className="w-full h-full pt-[35px] overflow-y-auto px-0 sm:px-0 md:px-0 lg:px-0 scrollbar scrollbar-w-4 scrollbar-thumb-gray-400 scrollbar-track-transparent">
          <div className="w-full h-full space-y-4 sm:space-y-6 md:space-y-8 p-0 m-0">
            {/* Profile Section */}
            <section className="flex flex-col lg:flex-row gap-0 sm:gap-0 md:gap-0 items-center justify-center lg:justify-start w-full p-0 m-0">
              <div className="flex-shrink-0 order-2 lg:order-1 w-full lg:w-auto max-w-xs mx-auto lg:mx-0 p-0 m-0">
              ...
              <div className="flex-1 text-center lg:text-left order-1 lg:order-2 w-full space-y-3 sm:space-y-4 md:space-y-6 p-0 m-0">
                <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 sm:mb-3 md:mb-4 font-poppins bg-gradient-to-r from-primary via-purple-600 to-secondary bg-clip-text text-transparent leading-tight p-0 m-0">
                  Gregory Vallim
                </h1>
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 justify-center lg:justify-start p-0 m-0">
                  <Badge variant="secondary" className="text-xs sm:text-sm md:text-base px-2 sm:px-3 py-1.5 sm:py-2 md:py-2.5 h-auto whitespace-normal p-0 m-0">
                    🚀 Full-Stack Developer
                  </Badge>
                  <Badge variant="outline" className="text-xs sm:text-sm md:text-base px-2 sm:px-3 py-1.5 sm:py-2 md:py-2.5 h-auto whitespace-normal p-0 m-0">
            ...
            {/* Content Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0 sm:gap-0 md:gap-0 w-full p-0 m-0">
              <article className="space-y-0 p-0 m-0 bg-muted/20 sm:bg-muted/30 rounded-xl sm:rounded-2xl border border-border/30 w-full p-0 m-0">
              ...
              <article className="space-y-0 p-0 m-0 bg-muted/20 sm:bg-muted/30 rounded-xl sm:rounded-2xl border border-border/30 w-full p-0 m-0">
                <div className="p-4 sm:p-6 md:p-8 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 sm:gap-2 md:gap-3 w-full p-0 m-0">
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">React</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">Next.js</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">TypeScript</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">Node.js</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">Tailwind</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">Prisma</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">PostgreSQL</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm md:text-base justify-center py-1.5 sm:py-2 p-0 m-0">AWS</Badge>
                  </div>
                </div>
              </article>
              
              <article className="space-y-0 p-0 m-0 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-xl sm:rounded-2xl border border-primary/20 lg:col-span-1 w-full p-0 m-0">
